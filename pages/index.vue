  ...
  div
    JeHeader
      #grid-header(slot="header-slot")
        ...
        p je chanvre est un message d'espoir.
    .grid-index
      .item-un
        JePhoto
      ...
      .item-deux
        JePhoto
          ...
          img.img-quart.trois(slot="photoTrois", src="~assets/img/img9.jpg")
          img.img-quart.quattre(slot="photoQuattre", src="~assets/img/img10.jpg")
      .item-trois
        JePhoto
          img.img-demi(slot="photoUn", src="~assets/img/img5.jpg")
          img.img-quart.trois(slot="photoDeux", src="~assets/img/img8.jpg")
          img.img-quart.quattre(slot="photoTrois", src="~assets/img/img2.jpg")
      .item-quatre
        JePhoto
